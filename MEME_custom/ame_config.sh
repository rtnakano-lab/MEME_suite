...
export cluster_file="/biodata/dep_psl/grp_psl/ThomasN/RNAseq2/210201project5002rgi/statistics/HiSat50-kmeans_47clusters_zerocenteredlog2cpm.seed0.txt"

# path to the directory where all intermediate files will be saved (no need to be already present)
export out_dir="/netscratch/dep_psl/grp_psl/ThomasN/MEME_suite/210201project5002rgi/HiSat50"

# path to the directory you want to store the final results
export results="/biodata/dep_psl/grp_psl/ThomasN/RNAseq2/210201project5002rgi/statistics/HiSat50_kmeans47-MEME_suite"
